...
<img src="media/pasta.pdf" alt="" width="80%">
...
Download the <a href="https://fcav.engin.umich.edu/projects/driving-in-the-matrix">Sim10k</a> dataset.

Once downloaded run the following command to process annotations.
```
